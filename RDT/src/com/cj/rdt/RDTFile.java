...
public class RDTFile extends RDTContainerTag {
	...
	public RDTVersion tryVersion() throws IOException {
		...
		if(!head.equals(RDT_FILE_HEAD))throw new IOException("Can't parse file as RDT File.");
		if(input.readByte()!=TAG_VERSION)throw new IOException("Can't read version information.");
